...
const DatasetGeneration = ({ ref }: { ref?: React.RefObject<HTMLDivElement | null> }) => {

  return (
    <div ref={ref} className="bg-transparent relative text-white h-screen w-screen snap-start p-[40px] pt-[100px] md:pt-[100px] lg:pt-[120px] p-[120px] md:p-[100px] lg:p-[120px] gap-[40px] md:gap-[200px] lg:gap-[250px] gap-[250px] overflow-hidden flex flex-col lg:flex-row items-center justify-between lg:max-h-screen">
      <section className="relative z-10 w-full lg:w-1/2 h-fit lg:h-full flex flex-col justify-top gap-6 md:gap-20 lg:justify-between">
        <div className="flex flex-col gap-2 md:gap-3">
          ...
          <p className="data_scapper_gradient_text text-[28px] md:text-[36px] lg:text-[48px] leading-[36px] md:leading-[48px] lg:leading-[60px]">
            Dataset Generation
          </p>
          <p className="max-w-[100%] md:max-w-[60%]  text-[14px] md:text-[16px] leading-5 md:leading-6 font-medium geist-font ">
