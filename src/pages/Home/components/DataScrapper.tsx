...
const DataScrapper = () => {
  ...
  return (
    <div className="bg-transparent relative text-white h-screen w-screen snap-start p-[40px] pt-[100px] md:pt-[100px] lg:pt-[120px] md:p-[60px] lg:pt-[80px] lg:pb-[120px] lg:p-[120px] gap-[100px] md:gap-[200px] lg:gap-[250px]  overflow-hidden flex flex-col lg:flex-row items-center justify-between">
      ...
      <section className="relative z-10 w-full h-1/2 lg:h-full flex flex-col justify-top gap-20 lg:justify-between">
        <div className="flex flex-col gap-3">
          <div className="flex gap-2 items-center">
            <p className="text-[14px] md:text-[16px] lg:text-[18px] nohemi-font lading-[20px] md:leading-[24px] lg:leading-[28px] leading-[28px] tracking-[1.8px] ">
              The hunt begins
            </p>
