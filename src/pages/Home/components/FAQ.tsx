...
const FAQ: React.FC = React.memo(() => {
  ...
  return (
    <div className="bg-data-scrapper2 relative text-white  p-[40px] md:p-[60px] lg:p-[60px] xl:p-[80px]  gap-[60px] lg:gap-[40px] xl:gap-[60px] overflow-hidden flex flex-col lg:flex-row items-center  lg:snap-start lg:h-screen w-screen py-[60px] lg:py-0 lg:justify-center">
      <motion.section
        className="w-full lg:w-[35%] flex flex-col gap-3 lg:gap-2 xl:gap-3"
      ...
      >
        <motion.div
          className="flex gap-2 -ml-[36px] md:ml-0 items-center text-white text-[14px] md:text-[16px] lg:text-[16px] xl:text-[18px] font-normal leading-[20px] md:leading-[24px] lg:leading-[24px] xl:leading-[28px] tracking-[1.8px] nohemi-font"
        ...
        <motion.h2
          className="text-[28px] md:text-[36px] text-center md:text-left lg:text-[36px] xl:text-[48px] font-medium leading-[36px] md:leading-[48px] lg:leading-[44px] xl:leading-[60px] nohemi-font"
          variants={headerItemVariants}
        >
          Frequently Asked Questions
        </motion.h2>
        <motion.p
          className="text-[14px] md:text-[16px] lg:text-[14px] xl:text-[16px] text-center md:text-left w-[100%] md:w-[70%] lg:w-[60%] font-normal leading-5 md:leading-6 lg:leading-5 xl:leading-6 geist-font text-white"
          variants={headerItemVariants}
        >
        ...
        {faqs.map((faq, index) => (
          ...
          >
            <motion.button
              ...
              className="w-full flex items-center justify-between p-6 lg:p-4 xl:p-6 pb-3 lg:pb-2 xl:pb-3 text-left   transition-colors"
              whileHover={{ scale: 1.002 }}
              whileTap={{ scale: 0.998 }}
              transition={{ duration: 0.2 }}
            >
              <span className="text-[16px] md:text-[18px] lg:text-[16px] xl:text-[20px] font-normal leading-[24px] md:leading-[28px] lg:leading-[24px] xl:leading-[32px] geist-font text-white">
                {faq.question}
              </span>
              <motion.div
            ...
            <AnimatePresence initial={false}>
              {openIndex === index && (
                ...
                >
                  <motion.div
                    className="p-6 lg:p-4 xl:p-6 pt-0 text-[14px] md:text-[16px] lg:text-[14px] xl:text-[16px]  font-normal leading-5 md:leading-6 lg:leading-5 xl:leading-6 geist-font text-[#B0B0B0]"
                    initial={{ y: -10 }}
                    animate={{ y: 0 }}
